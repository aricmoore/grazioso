...
public class Driver {
	...
	private static void initializeDogList() {
		Dog dog1 = new Dog("Spot", "German Shepherd", "male", "1", "25.6", false, TrainingStatus.IN_SERVICE, "05-12-2019", "United States", "United States");
		Dog dog2 = new Dog("Rex", "Great Dane", "male", "3", "35.2", false, TrainingStatus.PHASE_III, "02-03-2020", "United States", "United States");
		Dog dog3 = new Dog("Bella", "Chihuahua", "female", "4", "25.6", true, TrainingStatus.IN_SERVICE, "12-12-2019", "Canada", "Canada");
	...
	private static void initializeMonkeyList() {
		Monkey monkey1 = new Monkey("Bojangles", "female", "10", "46.7", "macaque", "2.3", "3.2", "100", false, TrainingStatus.IN_SERVICE, "12-12-2019", "Canada", "Canada");
		Monkey monkey2 = new Monkey("Alabaster Jones", "male", "35", "56.2", "guenon", "4.3", "5.6", "234", false, TrainingStatus.PHASE_I, "02-03-2020", "United States", "United States");
		Monkey monkey3 = new Monkey("Steve", "female", "200", "77.3", "capuchin", "2.6", "4.5", "201", true, TrainingStatus.INTAKE, "12-12-2019", "Canada", "Canada");
	...
	private static void printAvailableAnimalsByType(String animalType) {
		...
		System.out.println("Dogs initialized: " + dogList.size());
		System.out.println("Monkeys initialized: " + monkeyList.size());
