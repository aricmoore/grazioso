...
public class Driver {
	...
	private static void intakeNewDog(Scanner scanner) {
		...
		Gender gender = promptForGender(scanner, "dog");
    ...
    Gender gender = promptForGender(scanner, "monkey");
	...
	private static Gender promptForGender(Scanner scanner, String animalType) {
