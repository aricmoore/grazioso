...
public class Driver {
	...
	public static void initializeDogList() {
		Dog dog1 = new Dog("Spot", "German Shepherd", "male", "1", "25.6", "05-12-2019", "United States", RescueAnimal.TrainingStatus.INTAKE, false, "United States");
		Dog dog2 = new Dog("Rex", "Great Dane", "male", "3", "35.2", "02-03-2020", "United States", RescueAnimal.TrainingStatus.PHASE_I, false, "United States");
		Dog dog3 = new Dog("Bella", "Chihuahua", "female", "4", "25.6", "12-12-2019", "Canada", RescueAnimal.TrainingStatus.IN_SERVICE, true, "Canada");
	...
	public static void initializeMonkeyList() {
		Monkey monkey1 = new Monkey("Bojangles", "female", "10", "46.7", "macaque", "2.3", "3.2", "100", "12-12-2019", "Canada", RescueAnimal.TrainingStatus.INTAKE, true, "Canada");
		Monkey monkey2 = new Monkey("Alabaster Jones", "male", "35", "56.2", "guenon", "4.3", "5.6", "234", "02-03-2020", "United States", RescueAnimal.TrainingStatus.PHASE_I, false, "United States");
		Monkey monkey3 = new Monkey("Steve", "female", "200", "77.3", "capuchin", "2.6", "4.5", "201", "12-12-2019", "Canada", RescueAnimal.TrainingStatus.INTAKE, true, "Canada");
    ...
    if (!allowedSpecies.contains(species)) {
        System.out.println("\n\nInvalid species. Allowed species are: " + allowedSpecies + "\n\n");
        return; // Exit method, ask for menu input again
    }
