...
public class Monkey extends RescueAnimal {
	...
	// Default constructor
	public Monkey() {
		setAnimalType("monkey"); // Ensure animalType is set to "monkey"
	}

	// Detailed constructor - without fields set internally (like acquisitionDate etc)
	public Monkey(String name, String gender, String age,
		...
		setAcquisitionDate(RescueAnimalHelper.generateAcquisitionDate());
		setAcquisitionLocation(RescueAnimalHelper.generateAcquisitionLocation());
		setInServiceCountry(RescueAnimalHelper.generateInServiceCountry());
